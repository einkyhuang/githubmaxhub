...
// TOOLS_DATA_START
const TOOLS_UPDATE_DATE = '2026-09-04';

const FEATURED_IDS = ["openclaw", "superpowers", "hermes-agent", "autogpt", "opencode", "claude-code", "gemini-cli", "browser-use", "openhands", "dify", "n8n", "firecrawl", "ragflow", "mem0", "llama-index", "gpt-researcher", "lightrag", "docling", "langfuse", "litellm", "comfyui", "whisper", "open-sora", "vibevoice"];
