...
// TOOLS_DATA_START
var TOOLS_UPDATE_DATE = '2026-05-27';
...
var TOOLS = [
    ...
    { id:'openclaw', name:'OpenClaw', url:'https://github.com/openclaw/openclaw', desc:'跨平台AI Agent框架，315k Stars登顶GitHub，支持Windows/Mac/Linux/Web/手机统一运行', category:'ai', tags:["AI Agent", "\u8de8\u5e73\u53f0", "\u591a\u7aef\u534f\u540c"], icon:'🤖', featured:true, platform:["web", "mac", "windows", "linux", "ios", "android"] },
    { id:'superpowers', name:'Superpowers', url:'https://github.com/obra/superpowers', desc:'面向AI编码Agent的TDD开发框架，210k Stars，单日新增超1.5k星', category:'ai', tags:["AI Agent", "TDD", "AI\u7f16\u7801", "\u5f00\u53d1\u65b9\u6cd5\u8bba"], icon:'🧪', featured:true, platform:["web"] },
    { id:'hermes-agent', name:'Hermes Agent', url:'https://github.com/NousResearch/hermes-agent', desc:'自适应生长的AI Agent系统，168k Stars，周增长率9.2%，持续学习自我进化', category:'ai', tags:["AI Agent", "\u81ea\u9002\u5e94", "\u81ea\u4e3bAgent"], icon:'🧠', featured:true, platform:["web"] },
    { id:'karpathy-skills', name:'Karpathy Skills', url:'https://github.com/multica-ai/andrej-karpathy-skills', desc:'前特斯拉AI总监Karpathy的Claude Skills合集，149k Stars，月增80k', category:'ai', tags:["AI\u6280\u80fd", "Claude", "\u5f00\u53d1\u65b9\u6cd5\u8bba"], icon:'🌟', featured:true, platform:["web"] },
    { id:'anthropic-skills', name:'Anthropic Skills', url:'https://github.com/anthropics/skills', desc:'Anthropic官方Agent Skills仓库，140k Stars，可复用的AI Agent能力模块集合', category:'ai', tags:["AI\u6280\u80fd", "Claude", "\u53ef\u590d\u7528"], icon:'📦', featured:true, platform:["web"] },
    { id:'open-design', name:'Open Design', url:'https://github.com/nexu-io/open-design', desc:'开源Claude Design替代品，42k Stars（月增34k），71套设计系统，支持多格式导出', category:'ai', tags:["AI\u8bbe\u8ba1", "\u539f\u578b", "\u8bbe\u8ba1\u7cfb\u7edf"], icon:'🎨', featured:true, platform:["web"] },
    { id:'trading-agents', name:'TradingAgents', url:'https://github.com/TauricResearch/TradingAgents', desc:'多Agent金融交易框架，88k Stars，数据分析+策略+风控协同决策', category:'ai', tags:["\u591a\u667a\u80fd\u4f53", "\u91d1\u878d", "\u81ea\u52a8\u5316"], icon:'📈', featured:false, platform:["web"] },
    { id:'ui-tars-desktop', name:'UI-TARS Desktop', url:'https://github.com/bytedance/UI-TARS-desktop', desc:'字节跳动多模态AI Agent桌面端，38k Stars，跨应用GUI自动化', category:'ai', tags:["\u591a\u6a21\u6001Agent", "\u5b57\u8282\u8df3\u52a8", "\u684c\u9762\u7aef"], icon:'🖱️', featured:false, platform:["mac", "windows", "linux"] },
    { id:'free-claude-code', name:'Free Claude Code', url:'https://github.com/Alishahryar1/free-claude-code', desc:'免费版Claude Code集成方案，28k Stars，终端+VSCode+Discord三入口', category:'ai', tags:["Claude Code", "\u514d\u8d39", "VSCode"], icon:'🆓', featured:false, platform:["web", "mac", "windows", "linux"] },
    { id:'vllm', name:'vLLM', url:'https://github.com/vllm-project/vllm', desc:'高吞吐量LLM推理引擎，72k Stars，PagedAttention技术，生产级模型服务', category:'ai', tags:["\u63a8\u7406\u5f15\u64ce", "\u9ad8\u541e\u5410", "\u751f\u4ea7\u7ea7"], icon:'⚡', featured:false, platform:["web"] },
    { id:'cc-switch', name:'CC Switch', url:'https://github.com/farion1231/cc-switch', desc:'跨平台桌面AI Agent管理助手，72k Stars，集成主流Agent统一管理', category:'ai', tags:["\u684c\u9762\u7aef", "Agent\u7ba1\u7406", "\u8de8\u5e73\u53f0"], icon:'🖥️', featured:false, platform:["mac", "windows", "linux"] },
    { id:'openhands', name:'OpenHands', url:'https://github.com/All-Hands-AI/OpenHands', desc:'AI驱动全栈编码Agent，63k Stars，独立完成需求到代码全流程开发', category:'ai', tags:["AI\u7f16\u7801", "\u81ea\u52a8\u5316", "\u5168\u6808"], icon:'🤲', featured:false, platform:["web"] },
    { id:'12-factor-agents', name:'12-Factor Agents', url:'https://github.com/humanlayer/12-factor-agents', desc:'生产级LLM软件构建原则，24k Stars，12要素Agent方法论', category:'ai', tags:["\u751f\u4ea7\u7ea7", "\u6700\u4f73\u5b9e\u8df5", "\u8f6f\u4ef6\u5de5\u7a0b"], icon:'🏗️', featured:false, platform:["web"] },
    { id:'deep-research', name:'Deep Research', url:'https://github.com/jina-ai/deep-research', desc:'Jina AI深度研究Agent，35k Stars，本地加密+多搜索引擎', category:'ai', tags:["\u7814\u7a76", "\u672c\u5730\u5316", "RAG"], icon:'🔬', featured:false, platform:["web"] },
    { id:'hyperframes', name:'HyperFrames', url:'https://github.com/heygen-com/hyperframes', desc:'HTML直接渲染为视频引擎，21k Stars，代码即视频，短视频创作新范式', category:'ai', tags:["\u89c6\u9891\u751f\u6210", "HTML", "HeyGen"], icon:'🎬', featured:false, platform:["web"] },
    { id:'pixelle-video', name:'Pixelle Video', url:'https://github.com/AIDC-AI/Pixelle-Video', desc:'阿里AIDC全自动短视频生成引擎，20k Stars，AI剧本+画面+配音一站式', category:'ai', tags:["\u89c6\u9891\u751f\u6210", "\u963f\u91cc", "\u81ea\u52a8\u5316"], icon:'📹', featured:false, platform:["web"] },
    { id:'goose', name:'Goose', url:'https://github.com/block/goose', desc:'Block开源AI编码Agent，24k Stars，终端原生体验，多模型后端支持', category:'ai', tags:["AI\u7f16\u7801", "Block", "\u7ec8\u7aef"], icon:'🪿', featured:false, platform:["mac", "windows", "linux"] },
    { id:'servicedock', name:'ServiceDock', url:'https://github.com/servicedock/servicedock', desc:'一站式Agentic编程后端，32k Stars，数据库+认证+存储+AI网关集成', category:'ai', tags:["\u540e\u7aef", "\u57fa\u7840\u8bbe\u65bd", "\u5168\u6808AI"], icon:'🔌', featured:false, platform:["web"] },
    { id:'agents-best-practices', name:'Agents Best Practices', url:'https://github.com/DenisSergeevitch/agents-best-practices', desc:'AI编码Agent运行时框架设计规范，38k Stars，标准化Agent行为准则', category:'ai', tags:["Agent\u5de5\u7a0b", "\u6700\u4f73\u5b9e\u8df5", "\u8fd0\u884c\u65f6"], icon:'📋', featured:false, platform:["web"] },
    { id:'codegraph', name:'CodeGraph', url:'https://github.com/colbymchenry/codegraph', desc:'预索引代码知识图谱，19k Stars，100%本地运行，减少Token消耗', category:'ai', tags:["\u77e5\u8bc6\u56fe\u8c31", "\u672c\u5730", "Token\u4f18\u5316"], icon:'🕸️', featured:false, platform:["web"] },
    { id:'claude-context', name:'Claude Context', url:'https://github.com/zilliztech/claude-context', desc:'Claude Code MCP代码搜索工具，8k Stars，全代码库上下文，语义搜索', category:'ai', tags:["MCP", "\u4ee3\u7801\u641c\u7d22", "Claude Code"], icon:'🔗', featured:false, platform:["web"] },
    { id:'hello-agents', name:'Hello Agents', url:'https://github.com/datawhalechina/hello-agents', desc:'从零构建AI智能体实践教程，48k Stars，Datawhale社区，中文AI Agent教育标杆', category:'ai', tags:["\u6559\u7a0b", "\u5b9e\u8df5", "Datawhale"], icon:'📖', featured:false, platform:["web"] },
    { id:'ai-engineering-from-scratch', name:'AI Engineering From Scratch', url:'https://github.com/rohitg00/ai-engineering-from-scratch', desc:'从零开始AI工程项目教程，14k Stars，学习+构建+交付完整闭环', category:'ai', tags:["\u6559\u7a0b", "AI\u5de5\u7a0b", "\u5b9e\u8df5"], icon:'🚀', featured:false, platform:["web"] },
    { id:'vimax', name:'ViMax', url:'https://github.com/HKUDS/ViMax', desc:'Agentic视频生成框架，8k Stars，导演+编剧+制片+生成一体化', category:'ai', tags:["\u89c6\u9891\u751f\u6210", "Agent", "\u6e2f\u5927"], icon:'🎥', featured:false, platform:["web"] },
    { id:'memvid', name:'Memvid', url:'https://github.com/memvid/memvid', desc:'AI Agent单文件内存层，12k Stars，替代复杂RAG流程，Rust高性能', category:'ai', tags:["\u5185\u5b58\u5c42", "RAG", "Rust"], icon:'💾', featured:false, platform:["web"] },
    { id:'aitoearn', name:'AiToEarn', url:'https://github.com/yikart/AiToEarn', desc:'AI驱动内容变现平台，16k Stars，创作者经济自动化，内容生产/分发/变现', category:'ai', tags:["\u5185\u5bb9\u53d8\u73b0", "\u521b\u4f5c\u8005", "AI\u9a71\u52a8"], icon:'💰', featured:false, platform:["web"] }
