...
const TRENDS = [
  {
    "title": "LangChain缔造百万Star里程碑，AI开源进入新时代",
    "desc": "LangChain于2026年3月成为GitHub历史首个突破100万Star的AI项目，和OpenClaw 382k一起标志着AI开源从「百万行代码」到「百万星」的新纪元。Superpowers 225.5k、ECC 216k、Hermes 200k紧随其后。"
  },
  {
    "title": "Skills成为Agent生态「操作系统」级基础设施",
    "desc": "Superpowers 225.5k定义Skill标准→Anthropic Skills 152.1k官方实现→Matt Pocock Skills 162k+Karpathy Skills 162k个人开源→Taste Skill 37.5k品味工程，Skills从技术标准演进为生态操作系统。"
  },
  {
    "title": "Token压缩与成本优化成2026刚需赛道",
    "desc": "Headroom 40.7k（单周+14k月最大黑马）+ECC 216k（Token省40-60%）+codebase-memory-mcp减少99%Token，开发者对Token成本的焦虑催生了全新工具品类。在RAG场景Token成本可砍到原来1/10。"
  },
  {
    "title": "终端Agent新三强格局确立：OpenCode vs Claude Code vs Gemini CLI",
    "desc": "OpenCode 158k以完全开源多LLM策略打破格局，与Claude Code 138k、Gemini CLI 109.5k形成终端Agent新三强。OpenAI Codex 90k巩固第四极，Kilo Code 23.1k作为开源黑马崛起。"
  },
  {
    "title": "Agent记忆与知识图谱成为核心差异化赛道",
    "desc": "AgentMemory 22.5k（月增14k）/ Understand Anything 59.5k（月增45k登顶）/ CodeGraph 49k（月增48k）/ Graphify 5.5k（动态图谱），代码库从文件列表进化为可检索、可问询的交互知识网络。"
  },
  {
    "title": "Agent安全从「可选」变为「必选」",
    "desc": "MXC 4.2k（微软策略隔离）+ SkillSpector 5.3k（NVIDIA Skill安全扫描）+ agent-governance-toolkit覆盖OWASP Top 10。6月AI Agent误删事故直接把安全问题推到前台，安全成为Agent基础设施层必备。"
  },
  {
    "title": "视频多模态从「单模型」转向「多Agent分工」",
    "desc": "MoneyPrinterTurbo 84.5k（全自动）+ OpenMontage 6.7k（12管线52工具Agentic制作）+ ViMax（导演编剧制片Agent协同），视频AI从一键出片进化到Agent协同编排。"
  },
  {
    "title": "Apple Container引爆Mac容器化浪潮",
    "desc": "Apple Container 37k Stars月增10k。Swift原生+Apple Silicon优化，无需Docker daemon极速启动，对AI Agent开发者来说本地推理内存开销少30-50%。重新定义Mac开发环境。"
  },
  {
    "title": "金融AI Agent双雄确立垂直赛道最热战场",
    "desc": "TradingAgents 85.5k+AI Hedge Fund 54.5k。Multi-Agent量化交易和投资决策成为垂直AI最热战场，专业领域Agent应用标杆。"
  },
  {
    "title": "本地优先：从TTS到LLM的全栈端侧部署",
    "desc": "Ollama 174k+vLLM 65k+Unsloth 18.2k+TurboVec 11.5k+Apple Container 37k，本地部署从极客玩具变成生产级需求。隐私、成本、可控性三因素推动这波趋势。"
  },
  {
    "title": "浏览器Agent基础设施超越传统爬虫生态",
    "desc": "Browser Use 99.5k（超越Puppeteer）+Firecrawl 133.5k+CloakBrowser 15.9k，AI驱动Web自动化新生态日益庞大。传统爬虫工具正在被AI Agent重新定义。"
  },
  {
    "title": "AI开源生态三层架构成熟，工程化思维取代模型竞赛",
    "desc": "入口层(OpenClaw/Claude Code/Codex)→技能编排层(Superpowers/LangChain/ECC/CrewAI)→基础设施层(Ollama/vLLM/Unsloth/LangFuse)。热榜不再比谁家模型强，而是比模型如何被组织成可复用、可调试、可协作的工程系统。"
  }
];
// DATA_END
